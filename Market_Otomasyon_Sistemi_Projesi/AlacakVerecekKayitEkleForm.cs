...
{
    public partial class AlacakVerecekKayitEkleForm : Form
    {
        public AlacakVerecekKayitEkleForm()
        {
            InitializeComponent();
        }
        ...
        public void KayitEkle()
        {
            ...
            {
                Ana_Ekran.BaglantiAc();
                string Sorgu = "INSERT INTO AlacakVerecekTablosu (KategoriID,Miktar,SonOdemeTarih,A_VKisiSinif,A_VKisiID,KayitTarih) Values (@KategoriID,@Miktar,@SonOdemeTarih,@A_VKisiSinif,@A_VKisiID,@KayitTarih)";
                ...
                if (EkleKomut.ExecuteNonQuery() == 1)
                    MessageBox.Show("Kayıt Eklendi", "Kayit Ekle Bilgilendirme Pennceresi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Ana_Ekran.Baglanti.Close();
            }
            catch (Exception Hata)
            {
        ...
        private void AlacakVerecekKayitEkleForm_Load(object sender, EventArgs e)
        {
            KategoriYukle();
        }
    }
